...
file_path = os.path.join(os.getcwd(), PYTHON_SCRIPT_DIR, STM_DIR, 'routes.txt')
#file_path = os.path.abspath(os.path.join(os.sep, STM_DIR, 'routes.txt'))
...
file_path = os.path.join(os.getcwd(), PYTHON_SCRIPT_DIR, STM_DIR, 'stops.txt')
with open(file_path,'r') as fin:
    dr = csv.DictReader(fin) # comma is default delimiter    
    #for i in dr:
        #print(i)
...
file_path = os.path.join(os.getcwd(), PYTHON_SCRIPT_DIR, STM_DIR, 'shapes.txt')
with open(file_path,'r') as fin:
    dr = csv.DictReader(fin) # comma is default delimiter    
    #for i in dr:
        #print(i)
...
file_path = os.path.join(os.getcwd(), PYTHON_SCRIPT_DIR, STM_DIR, 'calendar.txt')
with open(file_path,'r') as fin:
    dr = csv.DictReader(fin) # comma is default delimiter    
    #for i in dr:
        #print(i)
...
file_path = os.path.join(os.getcwd(), PYTHON_SCRIPT_DIR, STM_DIR, 'trips.txt')
with open(file_path,'r') as fin:
    dr = csv.DictReader(fin) # comma is default delimiter    
    #for i in dr:
        #print(i)
...
file_path = os.path.join(os.getcwd(), PYTHON_SCRIPT_DIR, STM_DIR, 'stop_times1.txt')
with open(file_path,'r') as fin:
    dr = csv.DictReader(fin) # comma is default delimiter    
    #for i in dr:
        #print(i)
...
file_path = os.path.join(os.getcwd(), PYTHON_SCRIPT_DIR, STM_DIR, 'stop_times2.txt')
with open(file_path,'r') as fin:
    dr = csv.DictReader(fin) # comma is default delimiter    
    stop_times_db = [(int(i['trip_id']),i['arrival_time'],i['departure_time'],i['stop_id'],int(i['stop_sequence'])) for i in dr]
...
file_path = os.path.join(os.getcwd(), PYTHON_SCRIPT_DIR, STM_DIR, 'stop_times3.txt')
with open(file_path,'r') as fin:
    dr = csv.DictReader(fin) # comma is default delimiter    
    stop_times_db = [(int(i['trip_id']),i['arrival_time'],i['departure_time'],i['stop_id'],int(i['stop_sequence'])) for i in dr]
